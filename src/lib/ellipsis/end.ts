 ...
 */
export default function endEllipsis<T extends NullableHTMLElement>(el: T, fullText: NullableString, width?: string): T {
  if (!el) {
  ...
  el.style.display = el.style.display === 'inline' ? 'inline-block' : el.style.display;
